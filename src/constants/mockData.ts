    ...
    problems: [
      {
        id: "burst-pipe",
        title: "Burst pipe",
        description: "Water escaping or pipe damage",
      },
      {
        id: "water-leak",
        title: "Water leak",
        description: "Visible leak or damp patch",
      },
      {
        id: "blocked-drain",
        title: "Blocked drain",
        description: "Drain not clearing",
      },
      {
        id: "blocked-toilet",
        title: "Blocked toilet",
        description: "Toilet blocked or overflowing",
      },
      {
        id: "no-hot-water",
        title: "No hot water",
        description: "Hot water has stopped working",
      },
      {
        id: "other-plumbing",
        title: "Other issue",
        description: "Something else urgent",
      },
    ],
  },
  {
...
export function getProblem(
  ...
  return (
    service.problems.find((problem) => problem.id === id) ?? service.problems[0]
  );
}
...
export function getUrgency(urgencyId?: string | string[]) {
  ...
  return (
    urgencyOptions.find((urgency) => urgency.id === id) ?? urgencyOptions[0]
  );
}

export const mockTotal = priceBreakdown.reduce(
