...
const styles = StyleSheet.create({
  ...
  pointText: { ...typography.smallMedium, color: colors.white, fontFamily: typography.family },
  route: {
    position: 'absolute',
    left: '28%',
    right: '28%',
  ...
  statBox: { flex: 1, backgroundColor: colors.surface, borderRadius: 18, padding: 18, gap: 5, ...shadows.soft },
  statLabel: { ...typography.small, color: colors.muted, fontFamily: typography.family },
  statValue: { ...typography.bodyStrong, color: colors.navy, fontFamily: typography.family },
